...
{
    public class ArrayClaimsPrincipalFactory<TAccount>(IAccessTokenProviderAccessor accessor) : AccountClaimsPrincipalFactory<TAccount>(accessor) where TAccount : RemoteUserAccount
    {
