...
{
    internal class NotificationSeeder(ApplicationDbContext dbContext) : GeneralSeeder<Notification>(dbContext)
    {
        internal static readonly List<Notification> notifications = [];

        static NotificationSeeder()
        {
